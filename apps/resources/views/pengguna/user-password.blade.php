...
<section class="content">
  ...
  <div class="box box-default">
    <div class="box-header with-border">
      <h3 class="box-title">Ubah Password Pengguna</h3>
    ...
    {!! csrf_field() !!}
          ...
          <!-- Tambahan -->
              <div class="form-group col-md-5">
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                  ...
                  <input type="password" class="form-control" placeholder="Password Lama" name="currentPassword" value="" required>
      ...
      <div class="box-footer">
        ...
        <a href="{{ url('/user') }}"><button type="button" class="btn btn-default">Cancel</button></a>
      </div>
      </form>
  <!--   </form> -->
  </div>
