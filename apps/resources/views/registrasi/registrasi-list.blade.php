                ...
                <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="...">
                        <a href="{{ url('registrasi/'.$koleksi->id.'/detail') }}"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"> </span> Detail</button></a>
