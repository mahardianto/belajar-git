...
<section class="content">
        ...
        <div class="col-md-12">
          ...
          <b>Gambar Detail Artefak:</b><br/><br/>
            @foreach ($pictures as $picture)
              <a href="{{ url($picture) }}" target="_blank"><img src="{{ url($picture) }}"></a>&nbsp;
            @endforeach
        </div>
      </div>
      @endforeach
  ...
  <div class="box-footer">
    <a href="{{ url('/registrasi/'.$koleksi->id.'/edit') }}"><button type="button" class="btn btn-info">Ubah Data Registrasi</button></a>&nbsp;<a href="{{ url('/artefak/edit/'.$koleksi->id.'/detail') }}"><button type="button" class="btn btn-primary">Ubah Data Inventaris</button></a>
  </div>
</div>
  <!-- /.box -->
</section>
