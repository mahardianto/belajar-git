  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{ url('/user') }}"><i class="fa fa-circle-o text-aqua"></i> List Users</a></li>
          <li><a href="{{ url('/user/add/') }}"><i class="fa fa-circle-o text-yellow"></i> Tambah User</a></li>
          <li><a href="{{ url('/user/remove/') }}"><i class="fa fa-circle-o text-red"></i> Hapus User</a></li>
        </ul>
      </li>
  </section>
  <!-- /.sidebar -->
