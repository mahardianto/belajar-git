...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      <!-- Error or Success Notif -->
      <div class="col-md-4">
        <form role="form" method="POST" action="{{ url('/rak') }}">
        {!! csrf_field() !!}
        <div class="form-group">
          ...
          <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            <label for="namaPropinsi">Tambah Nama Rak</label>
             <input type="text" class="form-control" placeholder="Nama Rak" name="name" value="{{ old('name') }}" pattern="([a-zA-Z0-9]| |/|\|@|#|$|%|&)+" required>
             @if ($errors->has('name'))
